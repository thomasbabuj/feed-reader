/* 
	Its helps to initialize the layout of the pages, attach events to the app
	page elements and use the Feed class to save, load and fetch feeds.	

	In this class initApplication() is the entry point
	Attaching specific handlers to each page initialization
...
var Application = {
   initApplication: function () {
      $(document)
         ...
         .on('pageinit', '#thomas-page', function () {
            Application.initThomasPage();
         })
